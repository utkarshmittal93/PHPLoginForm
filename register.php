...
if (isset($_POST['signup'])) {
    ...
    if ($count == 0) { // if email is not found add user
        ...
        $stmts = $conn->prepare("INSERT INTO users(firstname,lastname,username,email,password) VALUES(?, ?, ?, ?, ?)");
        $stmts->bind_param("sssss",$fname,$lname,$uname, $email, $password);
        ...
        <form method="post" autocomplete="off">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <button type="add" class="btn    btn-block btn-primary" name="addup" id="reg">ADD</button>
                
                    <button type="remove" class="btn    btn-block btn-primary" name="removeup" id="reg">REMOVE</button>
                </div>
